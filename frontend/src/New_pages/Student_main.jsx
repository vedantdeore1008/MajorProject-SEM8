...
import { NewNavbar } from "../FramerMotion/NewNavbar";
 ...
 // Import the AssignmentPage component
import { VscHome, VscArchive, VscAccount, VscSettingsGear } from "react-icons/vsc"; // Import icons for the Dock
import Dock_Reactbits from "../ReactBits/Dock_Reactbits";
import AssignmentPage from "../Student_page/AssignmentPage";

function Student_main() {
  const [activeSection, setActiveSection] = useState("Assignments"); // Default section

  // Function to render the active section
  const renderSection = () => {
    switch (activeSection) {
      case "Assignments":
        return <AssignmentPage></AssignmentPage>;
      case "Viva":
        return <div>Viva Section</div>;
      case "3D Chatbot":
        return <div>3D Chatbot Section</div>;
      case "VR Classroom":
        return <div>VR Classroom Section</div>;
      default:
  ...
  const dockItems = [
    ...
    {
      icon: <svg class="w-10 h-10 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
    ...
    {
      icon: <svg class="w-9 h-9 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
    ...
    ,
      label: "3D Chatbot",
      onClick: () => setActiveSection("3D Chatbot"),
    },
    {
      icon: <svg class="w-9 h-9 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
    ...
    ,
      label: "VR Classroom",
      onClick: () => setActiveSection("VR Classroom"),
    },
  ];
